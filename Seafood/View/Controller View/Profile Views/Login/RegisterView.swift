...
class RegisterView: UIView {
    ...
    func setupViews() {
        ...
        registerLabel.topAnchor.constraint(equalTo: seafoodImageView.bottomAnchor, constant: 15).isActive = true
        registerLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 15).isActive = true
        registerLabel.widthAnchor.constraint(equalTo: self.widthAnchor).isActive = true
        
        scrollView.addSubview(phoneLabel)
        phoneLabel.topAnchor.constraint(equalTo: registerLabel.bottomAnchor, constant: 30).isActive = true
        phoneLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 15).isActive = true
        phoneLabel.widthAnchor.constraint(equalToConstant: phoneLabel.intrinsicContentSize.width).isActive = true
        ...
        phoneNumberLabel.heightAnchor.constraint(equalToConstant: 22).isActive = true
        
        scrollView.addSubview(dividerLineView)
        dividerLineView.leadingAnchor.constraint(equalTo: phoneLabel.trailingAnchor, constant: 170).isActive = true
        dividerLineView.topAnchor.constraint(equalTo: phoneLabel.topAnchor, constant: -2).isActive = true
        dividerLineView.bottomAnchor.constraint(equalTo: phoneNumberLabel.bottomAnchor, constant: 2).isActive = true
        dividerLineView.widthAnchor.constraint(equalToConstant: 1).isActive = true
        
        scrollView.addSubview(changeNumberButton)
        changeNumberButton.leadingAnchor.constraint(equalTo: dividerLineView.trailingAnchor, constant: 5).isActive = true
        changeNumberButton.centerYAnchor.constraint(equalTo: dividerLineView.centerYAnchor).isActive = true
        ...
        scrollView.addSubview(registerButtonContainer)
        registerButtonContainer.topAnchor.constraint(equalTo: sendAgainButton.bottomAnchor, constant: 35).isActive = true
        registerButtonContainer.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 20).isActive = true
        registerButtonContainer.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -20).isActive = true
        registerButtonContainer.heightAnchor.constraint(equalToConstant: 50).isActive = true
        
        scrollView.addSubview(registerButton)
        registerButton.centerYAnchor.constraint(equalTo: registerButtonContainer.centerYAnchor).isActive = true
        registerButton.centerXAnchor.constraint(equalTo: registerButtonContainer.centerXAnchor).isActive = true
        
        scrollView.addSubview(cancelButton)
        cancelButton.topAnchor.constraint(equalTo: registerButtonContainer.bottomAnchor, constant: 30).isActive = true
